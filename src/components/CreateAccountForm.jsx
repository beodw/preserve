...
function CreateAccountForm({showSignIn}) {
  ...
  return (
    <>
    <h1 className='font-bold text-[16px] md:text-[30px] my-2'>Create an account</h1>
    <form className='w-full flex flex-col items-center mt-5' name="signin" onSubmit={(e)=>e.preventDefault()}>
      ...
      <div className='w-full max-w-sm mb-5'>
        ...
        <div id='accommodation-container' className='flex w-full border rounded-lg border-gray-200 p-3 md:p-4 outline-none'>
                <select id="accommodation" className='w-full outline-none'>
    ...
    <div className='w-full max-w-sm mb-5'>
      ...
      <button onClick={validate} type='button' className='max-w-sm mt-2 hover:bg-opacity-[.5] mb-5 w-full outline-none bg-preserve-secondary rounded-md p-3 md:p-4 flex items-center justify-center'>
